...
filetest:
	@make run KTEST=1 KTEST_WHITELIST=jinux_std::fs::exfat::test::test_new_exfat,test_create_and_list_file,test_write_and_read_file,test_write_and_read_file_direct,test_interleaved_write,test_mkdir,test_unlink_single,test_unlink_multiple,test_rmdir,test_rename_file,test_rename_dir,test_bitmap_modify_bit,test_bitmap_modify_chunk,test_bitmap_find,test_resize_single KTEST_CRATES=jinux-std